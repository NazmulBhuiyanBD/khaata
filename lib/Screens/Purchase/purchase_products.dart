                        ...
                        return Visibility(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                if (products[i].brand?.brandName != null)
                                  Text(
                                ...
                                if (products[i].color != null &&
                                    products[i].color!.isNotEmpty)
                                  Text(
                                ...
                                if (products[i].weight != null &&
                                    products[i].weight!.isNotEmpty)
                                  Text(
                                ...
                                if (products[i].capacity != null &&
                                    products[i].capacity!.isNotEmpty)
                                  Text(
